...
- [ ] **TASK-151 — Reduce oversized primary headline typography.** Presence-presentation correction requested after the public and owner hierarchy review: give the public Identity, unconfigured setup, published permalink, unavailable/access, and owner page headlines one restrained responsive scale while retaining their semantic hierarchy and long-content resilience. DoD: define and document bounded wide and narrow headline sizes with no primary heading above 4.5rem or below 2.25rem; keep every primary h1 larger than its related section headings at all supported widths while leaving update-card typography unchanged; preserve wrapping, balance, line height, native navigation, 320-pixel and 400-percent reflow, and public/owner distinction; add focused source and rendered regressions for representative short and maximum-length headings with no overflow or private-canary leak; record exact resolvable source/browser provenance and no schema, migration, protocol, runtime-setting, or hosting change; and pass focused and full validation. Depends on: TASK-148.
