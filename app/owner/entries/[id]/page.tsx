  ...
  return (
    <OwnerShell current="entries">
      <header className={`${styles.ownerPageHeader} ${styles.compactHeader}`}>
        <div>
          <p className="eyebrow">{entry.state === "published" ? "Public update" : "Private draft"}</p>
          <h1>Edit update</h1>
          <p>Saving replaces the current content in this Aitta without changing whether it is draft or published.</p>
        </div>
