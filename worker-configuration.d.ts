/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts --config wrangler.local.jsonc` (hash: 3ea9314dba41b69f8a19b346d2fa4b61)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AITTA_SOCIAL_OWNER_EMAIL" | "AITTA_SOCIAL_CANONICAL_URL" | "AITTA_SOCIAL_DEV_AUTH_EMAIL">> {}
}
